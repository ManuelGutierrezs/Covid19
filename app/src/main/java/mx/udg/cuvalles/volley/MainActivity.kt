...
import com.example.rastreocovid_19.PaisesAdapter
import mx.udg.cuvalles.volley.Pais
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        RecyclerView = findViewById(R.id.myRecyclerCovid)
        ...
        val peticionDatosCovid = JsonArrayRequest(Request.Method.GET,url,null,Response.Listener { response ->
            for (index in 0..response.length()-1){
                try{
                    ...
                    val paisIndivual = Pais(nombrePais,numeroConfirmador,numeroMuertos,numeroRecuperados,codigoPais)
